...
class ViewController: UIViewController {
    ...
    @IBAction func showLisbon() {
        var message = ""
        if cityLabel.text == "Lisbon" {
            message = "Your are Awesome. I am Lisbon!"
        } else {
            message = "I'm sorry... I'm not \(cityLabel.text!)!"
        }
    ...
    @IBAction func showLondon() {
        var message = ""
        if cityLabel.text == "London" {
            message = "Your are Awesome. I am London!"
        } else {
            message = "I'm sorry... I'm not \(cityLabel.text!)!"
        }
    ...
    @IBAction func showParis() {
        var message = ""
        if cityLabel.text == "Paris" {
            message = "Your are Awesome. I am Paris!"
        } else {
            message = "I'm sorry... I'm not \(cityLabel.text!)!"
        }
